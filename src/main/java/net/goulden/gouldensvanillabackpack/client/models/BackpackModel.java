...
public class BackpackModel {
    ...
    public static LayerDefinition createBlockLayer() {
        ...
        PartDefinition base = meshdefinition.getRoot().addOrReplaceChild("base", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -11.0F, -4.0F, 10.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition base = meshdefinition.getRoot().addOrReplaceChild("base", CubeListBuilder.create().texOffs(40, 0).addBox(-7.0F, -10.0F, -4.5F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.6F))
